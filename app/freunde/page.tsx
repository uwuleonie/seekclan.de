              ...
              <div>
                {accepted.map(f => (
                  <div key={f.id} className="flex items-center gap-4 px-6 py-4" style={{ borderBottom: '1px solid var(--card-border)' }}>
                    <img src={`/api/player-heads/${getFriendName(f)}/40`} alt={getFriendName(f)} className="w-10 h-10 rounded-xl" />
          ...
          <div className="space-y-4">
            ...
            {incoming.length > 0 && (
              <div className="card rounded-2xl overflow-hidden">
                ...
                {incoming.map(f => (
                  <div key={f.id} className="flex items-center gap-4 px-6 py-4" style={{ borderBottom: '1px solid var(--card-border)' }}>
                    <img src={`/api/player-heads/${f.sender.username}/40`} alt={f.sender.username} className="w-10 h-10 rounded-xl" />
                    <div className="flex-1">
            ...
            {outgoing.length > 0 && (
              <div className="card rounded-2xl overflow-hidden">
                ...
                {outgoing.map(f => (
                  <div key={f.id} className="flex items-center gap-4 px-6 py-4" style={{ borderBottom: '1px solid var(--card-border)' }}>
                    <img src={`/api/player-heads/${f.receiver.username}/40`} alt={f.receiver.username} className="w-10 h-10 rounded-xl" />
                    <div className="flex-1">
