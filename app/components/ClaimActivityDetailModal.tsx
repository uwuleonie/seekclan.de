...
export default function ClaimActivityDetailModal({ claimId, groupId, onClose }: Props) {
  ...
  // Aktivität nach Typ gruppieren, innerhalb jedes Typs nach Häufigkeit sortiert
