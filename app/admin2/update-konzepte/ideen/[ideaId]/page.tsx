...
export default function IdeaDetailPage() {
  ...
  const deleteIdea = async () => {
    ...
    if (res.ok) router.push('/admin2/update-konzepte/ideen')
  }
  ...
  if (notFound || !idea) {
    return (
      <div>
        ...
        <Link href="/admin2/update-konzepte/ideen" className="text-sm underline mt-2 inline-block" style={{ color: 'var(--muted)' }}>← Zurück zur Übersicht</Link>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-3xl">
      <Link href="/admin2/update-konzepte/ideen" className="text-sm inline-flex items-center gap-1 mb-6 hover:opacity-70 transition-all" style={{ color: 'var(--muted)' }}>
